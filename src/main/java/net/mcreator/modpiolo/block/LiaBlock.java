...
package net.mcreator.modpiolo.block;
...
public class LiaBlock extends ModpioloElements.ModElement {
	@ObjectHolder("modpiolo:lia")
	public static final Block block = null;
	public LiaBlock(ModpioloElements instance) {
		super(instance, 2);
	}
